...
public class MetaModelController {
    ...
    @GetMapping("/getNumberMetaModelByMonth/{year}")
    public List<Integer> getNumberMetaModelByMonth(@PathVariable int year) {
        return metaModelServiceImpl.getNumberMetaModelsByMonth(year);
    }
