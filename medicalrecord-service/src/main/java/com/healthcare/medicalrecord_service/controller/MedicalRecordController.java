...
public class MedicalRecordController {
    ...
    public ResponseEntity<MedicalRecord> createMedicalRecord(Authentication authentication) {
        UUID agentId = UUID.fromString((String) authentication.getPrincipal());
        return ResponseEntity.ok(medicalRecordAdminServiceImpl.createMedicalRecord(agentId));
    }
